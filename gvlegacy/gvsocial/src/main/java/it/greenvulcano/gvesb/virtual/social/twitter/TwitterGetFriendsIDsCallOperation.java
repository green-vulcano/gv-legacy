...
import it.greenvulcano.gvesb.social.twitter.directcall.TwitterOperationGetFriendsIDs;
...
/**
 * Class defining a call to getFriensIDs on Twitter.
 * 
 * @version 4.0.0 - Feb 2017
 * @author GreenVulcano Developer Team
 */
public class TwitterGetFriendsIDsCallOperation extends TwitterSocialCallOperation {
    private static Logger logger = LoggerFactory.getLogger(TwitterGetFriendsIDsCallOperation.class);
	...
	public void init(Node node) throws InitializationException {
		try{
            ...
            logger.error("ERROR TwitterGetFriendsIDsCallOperation[" + getName() + "] initialization", exc);
	...
	public GVBuffer perform(GVBuffer gvBuffer) throws ConnectionException,
		...
		try {
        	...
        	logger.error("ERROR TwitterGetFriendsIDsCallOperation[" + getName() + "] execution", exc);
