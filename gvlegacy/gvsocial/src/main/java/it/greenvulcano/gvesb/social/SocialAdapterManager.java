...
public class SocialAdapterManager implements ConfigurationListener {
    ...
    private static Logger logger = LoggerFactory.getLogger(SocialAdapterManager.class);
	...
	private SocialAdapter getAdapter(String socialName) {
		...
		try {
			...
			logger.error(e.toString()); // TODO: verificare se esiste un metodo per loggare direttamente l'errore
		}
		return adapter;
	}
