...
public class SFTPManager extends SSHManager
{
            ...
            Map<String, String> optProperties) throws RemoteManagerException
    {
        ...
        try {
            ...
            if (filenames != null) {
            	RegExLsEntryFilter fileFilter = new RegExLsEntryFilter(remoteFilePattern, RegExLsEntryFilter.ALL, -1);
            ...
            Map<String, String> optProperties) throws RemoteManagerException
    {
        ...
        try {
            ...
            if (filenames != null) {
            	RegExLsEntryFilter fileFilter = new RegExLsEntryFilter(fileNamePattern, fileTypeFilter,
            ...
            Map<String, String> optProperties) throws RemoteManagerException
    {
        ...
        try {
            ...
            if (filenames != null) {
            	RegExLsEntryFilter fileFilter = new RegExLsEntryFilter(entryNamePattern, RegExFileFilter.ALL, -1);
                for (LsEntry currFTPFile : filenames) {
                    if (currFTPFile != null) {
                        if (fileFilter.accept(currFTPFile)) {
                            if (currFTPFile.getAttrs().isDir()) {
