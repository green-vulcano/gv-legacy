...
public class ExcelWorkBook {
	private static Logger    logger              =  LoggerFactory.getLogger(ExcelWorkBook.class);
    ...
    public ExcelWorkBook(int a, File file, String defaultFormatName) throws ExcelException
    {
        workbook = null;
        currentSheet = 0;
        NMDC.push();
