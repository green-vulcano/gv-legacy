...
{
    private static final Logger logger      = org.slf4j.LoggerFactory.getLogger(JMSForwardListenerPool.class);
    ...
    public void init(Node node) throws JMSForwardException
    {
        try {
            ...
            try {
                ...
                executor = new ThreadPoolExecutor(data.getMaximumSize(), data.getMaximumSize() + 1, 10L, TimeUnit.MINUTES,
