...
{
    private static final Logger logger                     = LoggerFactory.getLogger(RemoteShellCallOperation.class);
    ...
    /**
     * Initalize the Remote Shell Call Operation
     * 
     * @param node
     ...
     * is used in order to call external systems. an <code>GVBuffer</code> 
    ...
    /**
     * Executes the shell command. Return the shell command output, as read from the standard output.
     * 
     * @param id
     ...
     * @return String
     * 
     * @see it.greenvulcano.gvesb.virtual.Operation#getServiceAlias(GVBuffer)
     */
    @Override
