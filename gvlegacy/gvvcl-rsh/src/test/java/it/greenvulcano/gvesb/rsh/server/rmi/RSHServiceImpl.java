...
public class RSHServiceImpl extends UnicastRemoteObject implements RSHService {
	...
	private static final Logger logger = LoggerFactory.getLogger(RSHServiceImpl.class);
	...
	public RSHServiceImpl(String id, int port, RMIClientSocketFactory csf, RMIServerSocketFactory ssf)
			throws RemoteException {
		super(port, csf, ssf);
		System.out.println("wrmpfmrios-------------" + port + csf + ssf);
		this.id = id;
	}
	 ...
	 * 
	 * @see
	 * it.greenvulcano.gvesb.rsh.server.rmi.RSHService#shellExec(it.greenvulcano
	 * .gvesb.rsh.server.cmd.helper.ShellCommandDef)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * it.greenvulcano.gvesb.rsh.server.rmi.RSHService#getFile(java.lang.String)
	 */
	@Override
	 ...
	 * Sends a file
	 * 
	 * @see it.greenvulcano.gvesb.rsh.server.rmi.RSHService#sendFile(java.lang.
	 * String, com.healthmarketscience.rmiio.RemoteInputStream)
	 */
	@Override
